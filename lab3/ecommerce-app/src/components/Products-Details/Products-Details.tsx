          ...
          <div className="lg:col-span-5 p-8 lg:p-12 flex flex-col justify-center bg-white">
            ...
            <div className="bg-gray-50 p-6 rounded-2xl mb-8 border border-gray-100">
                ...
                <div className="flex items-center justify-between">
                   ...
                   {/* هنا ممكن برضه نغير الرسالة لو الكمية خلصت في السلة */}
                   {!isOutOfStock && !isMaxStockReached ? (
                      <span className="text-green-600 font-bold bg-green-100 px-3 py-1 rounded-full text-xs">In Stock ({product.stock})</span>
                    ) : (
            ...
            <div className="flex flex-col gap-3 mt-auto">
               <button className="w-full bg-gray-900 text-white py-4 rounded-xl font-bold hover:bg-gray-800 transition shadow-lg flex items-center justify-center gap-2 text-lg">
                 Buy Now
               </button>
