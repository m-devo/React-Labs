  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <button onClick={() => navigate(-1)} className="flex items-center
       gap-2 text-gray-600 hover:text-blue-600 mb-6 transition font-bold group">
        <div className="bg-white p-2 rounded-full shadow-sm group-hover:shadow-md 
        border border-gray-100 transition"><ArrowLeft size={18} /></div> Back to Shop
      </button>
      
      <div className="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-12">
          
          <div className="lg:col-span-7 bg-white p-8 lg:p-12 flex 
          flex-col items-center justify-center border-b lg:border-b-0 lg:border-r border-gray-100 relative">
             <div className="relative z-10 w-full flex justify-center mb-8 h-[450px]">
                <img 
                  src={selectedImage} 
                  alt={product.title} 
                  className="h-full object-contain drop-shadow-2xl transition-opacity duration-300" 
                />
             </div>
             <div className="relative z-10 flex gap-4 mt-4 overflow-x-auto w-full justify-center px-4 pb-2">
               {product.images?.slice(0,4).map((img, idx) => {
                 ...
                 <button 
                    ...
                    className={`w-20 h-20 border-2 rounded-xl shadow-sm overflow-hidden cursor-pointer transition bg-white p-1 ${
          ...
          <div className="lg:col-span-5 p-8 lg:p-12 flex flex-col justify-center bg-white">
             <span className="text-blue-600 text-xs font-extrabold 
             tracking-widest uppercase mb-2 block bg-blue-50 w-fit px-2 py-1 rounded">
            ...
            <div className="bg-gray-50 p-6 rounded-2xl mb-8 border border-gray-100">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="text-right">
                    ...
                    block font-medium">Was ${(product.price * 1.2).toFixed(2)}</span>
                  </div>
                </div>
                <div className="flex items-center justify-between">
                   ...
                   {product.stock > 0 ? (
                      ...
                      <span className="text-red-600 font-bold bg-red-100 px-3 py-1 
                      rounded-full text-xs">Out of Stock</span>
                    )}
                </div>
            </div>

            <div className="flex flex-col gap-3 mt-auto">
               <button className="w-full bg-gray-900 text-white py-4 rounded-xl font-bold hover:bg-gray-800
                transition shadow-lg flex items-center justify-center gap-2 text-lg">
                 Buy Now
               </button>
               ...
               <button 
                 ...
                 className={`w-full border-2 border-gray-200 text-gray-900 py-4 r
                  ounded-xl font-bold hover:border-blue-600 hover:text-blue-600 hover:bg-blue-50 
